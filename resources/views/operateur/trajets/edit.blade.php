<x-panel-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl">Modifier un trajet</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('operateur.trajets.update', $trajet) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="mb-4">
                        ...
                        <select name="ligne_id" class="mt-1 block w-full border rounded px-3 py-2" required>
                            ...
                            @foreach($lignes as $ligne)
                                <option value="{{ $ligne->id }}" {{ old('ligne_id', $trajet->ligne_id) == $ligne->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="bus_id" class="mt-1 block w-full border rounded px-3 py-2" required>
                            <option value="">-- Choisir un de mes bus --</option>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="date_depart" value="{{ old('date_depart', $trajet->date_depart) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="time" name="heure_depart" value="{{ old('heure_depart', $trajet->heure_depart) }}"
                            class="mt-1 block w-full border rounded px-3 py-2" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="places_dispo" value="{{ old('places_dispo', $trajet->places_dispo) }}"
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('operateur.trajets.index') }}" class="bg-gray-400 text-white px-4 py-2 rounded hover:bg-gray-500">
                            Annuler
                        </a>
                    </div>
