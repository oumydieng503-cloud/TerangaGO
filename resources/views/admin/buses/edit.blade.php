<x-panel-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl">Modifier un bus</h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('admin.buses.update', $bus) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="numero" value="{{ old('numero', $bus->numero) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="capacite" value="{{ old('capacite', $bus->capacite) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <select name="operateur_id" class="mt-1 block w-full border rounded px-3 py-2" required>
                            ...
                            @foreach($operateurs as $operateur)
                                <option value="{{ $operateur->id }}" {{ old('operateur_id', $bus->operateur_id) == $operateur->id ? 'selected' : '' }}>
                                    {{ $operateur->name }}
                                </option>
                            @endforeach
                        </select>
